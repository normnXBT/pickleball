...
# Check if any player plays on the same team in previous rounds
if team1_player1 in player_teammates[team2_player1] or team1_player2 in player_teammates[team2_player1] or team1_player1 in player_teammates[team2_player2] or team1_player2 in player_teammates[team2_player2]:
  # If any player plays on the same team in previous rounds, continue to the next iteration of the loop
  # without adding the current round to the list of rounds
  continue

# Check if all players have played an approximately equal amount
player_games_played = {player: len(player_teammates[player]) for player in players}
min_games_played = min(player_games_played.values())
max_games_played = max(player_games_played.values())
if max_games_played - min_games_played >= 2:
  # If the difference is 2 or greater, continue to the next iteration of the loop without adding
  # the current round to the list of rounds
  continue
